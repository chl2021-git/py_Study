...
def xm_decrypt(raw_data):
    ...
    xm_encryptor = Instance(Module(
        ...
        pathlib.Path("D:\\Study\\py_Study\\TestPy\\xm_encryptor.wasm").read_bytes()
    ))
    # decode id3
...
if __name__ == "__main__":
    while True:
        print("wasm:",pathlib.Path("./xm_encryptor.wasm"))
        print("wasm2:",pathlib.Path())
        ...
        if choice == "1" or choice == "2":
            if choice == "1":
                ...
                while True:
                    ...
                    dir_to_decrypt = "D:\\NotePC\\日语学习\\日语红宝书N1-N5文字词汇详解mp3"
                    print("input:",dir_to_decrypt)
